...
import appscode_cloud_v1alpha2 "appscode.com/api/cloud/v1alpha2"
import _ "appscode.com/api/namespace/v1alpha1"
...
type Operation struct {
	...
	Type     OperationType       `protobuf:"varint,14,opt,name=type,enum=appscode.operation.v1alpha2.OperationType" json:"type,omitempty"`
...
func (m *Operation) GetClusterApplyRequest() *appscode_cloud_v1alpha2.ClusterApplyRequest {
...
func _Operation_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	...
	case 1: // request.cluster_apply_request
		...
		msg := new(appscode_cloud_v1alpha2.ClusterApplyRequest)
...
func (c *operationsClient) Describe(ctx context.Context, in *DescribeRequest, opts ...grpc.CallOption) (*DescribeResponse, error) {
	...
	err := grpc.Invoke(ctx, "/appscode.operation.v1alpha2.Operations/Describe", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *operationsClient) DescribeLog(ctx context.Context, in *LogDescribeRequest, opts ...grpc.CallOption) (*LogDescribeResponse, error) {
	...
	err := grpc.Invoke(ctx, "/appscode.operation.v1alpha2.Operations/DescribeLog", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
