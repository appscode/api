...
import (
	v1alpha1 "appscode.com/api/cloud/v1alpha1"
	v1alpha11 "appscode.com/api/namespace/v1alpha1"
	context "context"
	fmt "fmt"
...
type Operation struct {
	...
	Type                 OperationType       `protobuf:"varint,14,opt,name=type,proto3,enum=appscode.operation.v1alpha1.OperationType" json:"type,omitempty"`
...
type Operation_ClusterApplyRequest struct {
	ClusterApplyRequest *v1alpha1.ClusterApplyRequest `protobuf:"bytes,1,opt,name=cluster_apply_request,json=clusterApplyRequest,proto3,oneof"`
}

type Operation_NamespaceCreateRequest struct {
	NamespaceCreateRequest *v1alpha11.CreateRequest `protobuf:"bytes,11,opt,name=namespace_create_request,json=namespaceCreateRequest,proto3,oneof"`
}
...
func (m *Operation) GetClusterApplyRequest() *v1alpha1.ClusterApplyRequest {
...
func (m *Operation) GetNamespaceCreateRequest() *v1alpha11.CreateRequest {
...
func _Operation_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	...
	case 1: // request.cluster_apply_request
		...
		msg := new(v1alpha1.ClusterApplyRequest)
	...
	case 11: // request.namespace_create_request
		...
		msg := new(v1alpha11.CreateRequest)
		err := b.DecodeMessage(msg)
...
func (c *operationsClient) Describe(ctx context.Context, in *DescribeRequest, opts ...grpc.CallOption) (*DescribeResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/appscode.operation.v1alpha1.Operations/Describe", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *operationsClient) DescribeLog(ctx context.Context, in *LogDescribeRequest, opts ...grpc.CallOption) (*LogDescribeResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/appscode.operation.v1alpha1.Operations/DescribeLog", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
