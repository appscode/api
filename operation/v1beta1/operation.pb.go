...
import appscode_certificate_v1beta1 "github.com/appscode/api/certificate/v1beta1"
...
type Operation_DnsCheckRequest struct {
	DnsCheckRequest *appscode_certificate_v1beta1.DNSCheckRequest `protobuf:"bytes,13,opt,name=dns_check_request,json=dnsCheckRequest,oneof"`
}
type Operation_AlertSyncRequest struct {
	AlertSyncRequest *appscode_alert_v1beta1.AlertSyncRequest `protobuf:"bytes,18,opt,name=alert_sync_request,json=alertSyncRequest,oneof"`
}
...
func (m *Operation) GetDnsCheckRequest() *appscode_certificate_v1beta1.DNSCheckRequest {
...
func (m *Operation) GetAlertSyncRequest() *appscode_alert_v1beta1.AlertSyncRequest {
...
func _Operation_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	...
	case 13: // request.dns_check_request
		...
		msg := new(appscode_certificate_v1beta1.DNSCheckRequest)
		err := b.DecodeMessage(msg)
	...
	case 18: // request.alert_sync_request
		...
		msg := new(appscode_alert_v1beta1.AlertSyncRequest)
		err := b.DecodeMessage(msg)
...
var fileDescriptor0 = []byte{
	...
	,
}
