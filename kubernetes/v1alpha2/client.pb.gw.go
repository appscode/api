...
var (
	filter_Clients_List_0 = &utilities.DoubleArray{Encoding: map[string]int{"owner": 0, "cluster": 1, "type": 2}, Base: []int{1, 1, 2, 3, 0, 0, 0}, Check: []int{0, 1, 1, 1, 2, 3, 4}}
)
...
var (
	filter_Clients_Describe_0 = &utilities.DoubleArray{Encoding: map[string]int{"owner": 0, "cluster": 1, "type": 2, "name": 3}, Base: []int{1, 1, 2, 3, 4, 0, 0, 0, 0}, Check: []int{0, 1, 1, 1, 1, 2, 3, 4, 5}}
)
...
var (
	filter_Clients_Delete_0 = &utilities.DoubleArray{Encoding: map[string]int{"owner": 0, "cluster": 1, "type": 2, "name": 3}, Base: []int{1, 1, 2, 3, 4, 0, 0, 0, 0}, Check: []int{0, 1, 1, 1, 1, 2, 3, 4, 5}}
)
...
var (
	filter_Clients_UnregisterPersistentVolumeClaim_0 = &utilities.DoubleArray{Encoding: map[string]int{"owner": 0, "cluster": 1, "name": 2}, Base: []int{1, 1, 2, 3, 0, 0, 0}, Check: []int{0, 1, 1, 1, 2, 3, 4}}
)
...
var (
	filter_Clients_ReverseIndex_0 = &utilities.DoubleArray{Encoding: map[string]int{"owner": 0, "cluster": 1, "type": 2, "name": 3, "targetType": 4}, Base: []int{1, 1, 2, 3, 4, 5, 0, 0, 0, 0, 0}, Check: []int{0, 1, 1, 1, 1, 1, 2, 3, 4, 5, 6}}
)
...
var (
	filter_Disks_List_0 = &utilities.DoubleArray{Encoding: map[string]int{"owner": 0}, Base: []int{1, 1, 0}, Check: []int{0, 1, 2}}
)
...
var (
	filter_Disks_Describe_0 = &utilities.DoubleArray{Encoding: map[string]int{"owner": 0, "name": 1}, Base: []int{1, 1, 2, 0, 0}, Check: []int{0, 1, 1, 2, 3}}
)
...
var (
	filter_Disks_Delete_0 = &utilities.DoubleArray{Encoding: map[string]int{"owner": 0, "uid": 1}, Base: []int{1, 1, 2, 0, 0}, Check: []int{0, 1, 1, 2, 3}}
)
...
var (
	pattern_Clients_List_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4, 2, 5, 1, 0, 4, 1, 5, 6, 1, 0, 4, 1, 5, 7, 2, 8}, []string{"_appscode", "api", "kubernetes", "v1alpha2", "owner", "clusters", "cluster", "type", "json"}, ""))

	pattern_Clients_Describe_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4, 2, 5, 1, 0, 4, 1, 5, 6, 1, 0, 4, 1, 5, 7, 1, 0, 4, 1, 5, 8, 2, 9}, []string{"_appscode", "api", "kubernetes", "v1alpha2", "owner", "clusters", "cluster", "type", "name", "json"}, ""))

	pattern_Clients_Create_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4, 2, 5, 1, 0, 4, 1, 5, 6, 1, 0, 4, 1, 5, 7, 2, 8}, []string{"_appscode", "api", "kubernetes", "v1alpha2", "owner", "clusters", "cluster", "type", "json"}, ""))

	pattern_Clients_Delete_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4, 2, 5, 1, 0, 4, 1, 5, 6, 1, 0, 4, 1, 5, 7, 1, 0, 4, 1, 5, 8, 2, 9}, []string{"_appscode", "api", "kubernetes", "v1alpha2", "owner", "clusters", "cluster", "type", "name", "json"}, ""))

	pattern_Clients_Update_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4, 2, 5, 1, 0, 4, 1, 5, 6, 1, 0, 4, 1, 5, 7, 1, 0, 4, 1, 5, 8, 2, 9}, []string{"_appscode", "api", "kubernetes", "v1alpha2", "owner", "clusters", "cluster", "type", "name", "json"}, ""))

	pattern_Clients_Copy_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4, 2, 5, 2, 6, 2, 7}, []string{"_appscode", "api", "kubernetes", "v1alpha2", "owner", "actions", "copy", "json"}, ""))

	pattern_Clients_EditConfigMap_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4, 2, 5, 1, 0, 4, 1, 5, 6, 2, 7, 1, 0, 4, 1, 5, 8, 2, 9, 1, 0, 4, 1, 5, 10, 2, 11, 2, 12, 2, 13}, []string{"_appscode", "api", "kubernetes", "v1alpha2", "owner", "clusters", "cluster", "namespaces", "namespace", "configmaps", "name", "actions", "edit", "json"}, ""))

	pattern_Clients_EditSecret_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4, 2, 5, 1, 0, 4, 1, 5, 6, 2, 7, 1, 0, 4, 1, 5, 8, 2, 9, 1, 0, 4, 1, 5, 10, 2, 11, 2, 12, 2, 13}, []string{"_appscode", "api", "kubernetes", "v1alpha2", "owner", "clusters", "cluster", "namespaces", "namespace", "secrets", "name", "actions", "edit", "json"}, ""))

	pattern_Clients_RegisterPersistentVolume_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4, 2, 5, 1, 0, 4, 1, 5, 6, 2, 7, 1, 0, 4, 1, 5, 8, 2, 9, 2, 10, 2, 11}, []string{"_appscode", "api", "kubernetes", "v1alpha2", "owner", "clusters", "cluster", "persistentvolumes", "name", "actions", "register", "json"}, ""))

	pattern_Clients_UnregisterPersistentVolume_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4, 2, 5, 1, 0, 4, 1, 5, 6, 2, 7, 1, 0, 4, 1, 5, 8, 2, 9, 2, 10, 2, 11}, []string{"_appscode", "api", "kubernetes", "v1alpha2", "owner", "clusters", "cluster", "persistentvolumes", "name", "actions", "unregister", "json"}, ""))

	pattern_Clients_RegisterPersistentVolumeClaim_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4, 2, 5, 1, 0, 4, 1, 5, 6, 2, 7, 1, 0, 4, 1, 5, 8, 2, 9, 2, 10, 2, 11}, []string{"_appscode", "api", "kubernetes", "v1alpha2", "owner", "clusters", "cluster", "persistentvolumeclaims", "name", "actions", "register", "json"}, ""))

	pattern_Clients_UnregisterPersistentVolumeClaim_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4, 2, 5, 1, 0, 4, 1, 5, 6, 2, 7, 1, 0, 4, 1, 5, 8, 2, 9, 2, 10, 2, 11}, []string{"_appscode", "api", "kubernetes", "v1alpha2", "owner", "clusters", "cluster", "persistentvolumeclaims", "name", "actions", "unregister", "json"}, ""))

	pattern_Clients_ReverseIndex_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4, 2, 5, 1, 0, 4, 1, 5, 6, 1, 0, 4, 1, 5, 7, 1, 0, 4, 1, 5, 8, 2, 9, 1, 0, 4, 1, 5, 10, 2, 11}, []string{"_appscode", "api", "kubernetes", "v1alpha2", "owner", "clusters", "cluster", "type", "name", "reverse", "targetType", "json"}, ""))
)
...
var (
	pattern_Disks_List_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4, 2, 5, 2, 6}, []string{"_appscode", "api", "cloud", "v1alpha2", "owner", "disks", "json"}, ""))

	pattern_Disks_Describe_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4, 2, 5, 1, 0, 4, 1, 5, 6, 2, 7}, []string{"_appscode", "api", "cloud", "v1alpha2", "owner", "disks", "name", "json"}, ""))

	pattern_Disks_Create_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4, 2, 5, 2, 6}, []string{"_appscode", "api", "cloud", "v1alpha2", "owner", "disks", "json"}, ""))

	pattern_Disks_Delete_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4, 2, 5, 1, 0, 4, 1, 5, 6, 2, 7}, []string{"_appscode", "api", "cloud", "v1alpha2", "owner", "disks", "uid", "json"}, ""))
)
