...
func RegisterMailingListHandler(ctx context.Context, mux *runtime.ServeMux, conn *grpc.ClientConn) error {
	return RegisterMailingListHandlerClient(ctx, mux, NewMailingListClient(conn))
}

// RegisterMailingListHandler registers the http handlers for service MailingList to "mux".
// The handlers forward requests to the grpc endpoint over the given implementation of "MailingListClient".
// Note: the gRPC framework executes interceptors within the gRPC handler. If the passed in "MailingListClient"
// doesn't go through the normal gRPC flow (creating a gRPC client etc.) then it will be up to the passed in
// "MailingListClient" to call the correct interceptors.
func RegisterMailingListHandlerClient(ctx context.Context, mux *runtime.ServeMux, client MailingListClient) error {
