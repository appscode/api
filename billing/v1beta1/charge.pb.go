...
func init() {
	proto.RegisterType((*ChargeEstimateResponse)(nil), "billing.v1beta1.ChargeEstimateResponse")
}
...
func (c *chargesClient) Estimate(ctx context.Context, in *dtypes.VoidRequest, opts ...grpc.CallOption) (*ChargeEstimateResponse, error) {
	out := new(ChargeEstimateResponse)
	err := grpc.Invoke(ctx, "/billing.v1beta1.Charges/Estimate", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Charges_Estimate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/billing.v1beta1.Charges/Estimate",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ChargesServer).Estimate(ctx, req.(*dtypes.VoidRequest))
	}
	return interceptor(ctx, in, info, handler)
}

var _Charges_serviceDesc = grpc.ServiceDesc{
	ServiceName: "billing.v1beta1.Charges",
...
var fileDescriptor0 = []byte{
	...
	0x4a, 0x4f, 0xd5, 0x2b, 0x28, 0xca, 0x2f, 0xc9, 0x17, 0xe2, 0x4f, 0xca, 0xcc, 0xc9, 0xc9, 0xcc,
	...
	,
}
