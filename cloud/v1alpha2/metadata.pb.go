...
func (c *metadataClient) ListRegions(ctx context.Context, in *RegionListRequest, opts ...grpc.CallOption) (*RegionListResponse, error) {
	...
	err := grpc.Invoke(ctx, "/appscode.cloud.v1alpha2.Metadata/ListRegions", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *metadataClient) ListZones(ctx context.Context, in *ZoneListRequest, opts ...grpc.CallOption) (*ZoneListResponse, error) {
	...
	err := grpc.Invoke(ctx, "/appscode.cloud.v1alpha2.Metadata/ListZones", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *metadataClient) ListBuckets(ctx context.Context, in *BucketListRequest, opts ...grpc.CallOption) (*BucketListResponse, error) {
	...
	err := grpc.Invoke(ctx, "/appscode.cloud.v1alpha2.Metadata/ListBuckets", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
