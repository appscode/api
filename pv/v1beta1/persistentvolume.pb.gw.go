...
var (
	pattern_PersistentVolumes_Describe_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4, 1, 0, 4, 1, 5, 5, 1, 0, 4, 1, 5, 6}, []string{"appscode", "api", "pv", "v1beta1", "persistent-volumes", "cluster", "name"}, ""))

	pattern_PersistentVolumes_Register_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4, 1, 0, 4, 1, 5, 5, 1, 0, 4, 1, 5, 6}, []string{"appscode", "api", "pv", "v1beta1", "persistent-volumes", "cluster", "name"}, ""))

	pattern_PersistentVolumes_Unregister_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4, 1, 0, 4, 1, 5, 5, 1, 0, 4, 1, 5, 6}, []string{"appscode", "api", "pv", "v1beta1", "persistent-volumes", "cluster", "name"}, ""))
)
