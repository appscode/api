...
func (m *CredentialIsAuthorizedResponse) GetStatus() *dtypes.Status {
	if m != nil {
		return m.Status
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*CredentialIsAuthorizedRequest)(nil), "credential.v1beta1.CredentialIsAuthorizedRequest")
	proto.RegisterType((*CredentialIsAuthorizedResponse)(nil), "credential.v1beta1.CredentialIsAuthorizedResponse")
...
func (c *credentialsClient) IsAuthorized(ctx context.Context, in *CredentialIsAuthorizedRequest, opts ...grpc.CallOption) (*CredentialIsAuthorizedResponse, error) {
	...
	err := grpc.Invoke(ctx, "/credential.v1beta1.Credentials/IsAuthorized", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Credentials_IsAuthorized_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/credential.v1beta1.Credentials/IsAuthorized",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var fileDescriptor0 = []byte{
	...
	,
}
